...
public:
    /* A simple function that loads a QSS stylesheet, and is capable of handling failure by showing a messagebox.
     * The return value indicates whether or not the stylesheet was loaded successfully. */
